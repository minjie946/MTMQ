...
interface NoRepayDetailProps extends FormComponentProps, BaseProps {
  deliveryId: number
...
class NoRepayDetail extends RootComponent<NoRepayDetailProps, NoRepayDetailState> {
  constructor (props:NoRepayDetailProps) {
    super(props)
    this.state = {
      errorMsg: '',
      commissionInfo: {},
...
export default Form.create<NoRepayDetailProps>()(NoRepayDetail)
