...
import NoRepayDetailItem from './detail'

interface AdvanceNoRepayProps {
  history: any
}

interface AdvanceNoRepayState {
  serachParam:any
  visible:boolean
  deliveryId: number
...
export default class AdvanceNoRepay extends RootComponent<AdvanceNoRepayProps, AdvanceNoRepayState> {
  private serachParamData:any = {}
  constructor (props:AdvanceNoRepayProps) {
    super(props)
    this.state = {
      visible: false,
      serachParam: {},
    ...
    return (
      <div className='cus-home-content'>
        ...
        <TableItem
          ...
          columns={columnData}
        />
        <NoRepayDetailItem deliveryId={deliveryId} type={type} visible={visible} onCancel={this.handleModel} />
      </div>
    )
  }
}
