...
interface AllDetailProps extends FormComponentProps {
  deliveryId: number
...
class AllDetail extends RootComponent<AllDetailProps, AllDetailState> {
  constructor (props:AllDetailProps) {
    super(props)
    this.state = {
      errorMsg: '',
      commissionInfo: {},
...
export default Form.create<AllDetailProps>()(AllDetail)
