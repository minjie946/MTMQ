...
import PayDetailItem from './detail'
...
export default class AdvancePay extends RootComponent<AdvancePayProps, AdvancePayState> {
  private serachParamData:any = {}
  constructor (props:AdvancePayProps) {
    super(props)
    this.state = {
      visible: false,
      serachParam: {},
    ...
    return (
      <div className='cus-home-content'>
        ...
        <TableItem
          ...
          columns={columnData}
        />
        <PayDetailItem deliveryId={deliveryId} type={type} visible={visible} onCancel={this.handleModel} />
      </div>
    )
  }
}
