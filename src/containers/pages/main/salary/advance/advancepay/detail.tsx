...
interface PayDetailProps extends FormComponentProps {
  deliveryId: number
...
class PayDetail extends RootComponent<PayDetailProps, PayDetailState> {
  constructor (props:PayDetailProps) {
    super(props)
    this.state = {
      errorMsg: '',
      commissionInfo: {},
...
export default Form.create<PayDetailProps>()(PayDetail)
